...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 29, 2025 at 05:50 AM
...
(2, 'Learning Management System', 9, '2025-08-28', '2025-08-28', 'Nothing');
...
--
-- Dumping data for table `password_updates`
--

INSERT INTO `password_updates` (`id`, `user_id`, `old_password_hash`, `updated_at`) VALUES
(1, 22, '$2y$10$DgW5dYRrg5yoE4YU8ofsmeNDN6p2Fc2xcNKLSdkoPZuX61v.rAQPq', '2025-08-26 03:12:51');
...
(4, 9, '95000.00', '0.00', '0.00', '2025-08-29', '', '2025-08-29 03:45:44');
...
(1, 2, 'In Progress', NULL, 9, '2025-08-29 03:40:39'),
(2, 2, 'In Progress', NULL, 9, '2025-08-29 03:40:50'),
(3, 2, 'On Hold', NULL, 9, '2025-08-29 03:40:54'),
(4, 2, 'In Progress', NULL, 9, '2025-08-29 03:41:05');
...
(22, 'yash', '$2y$10$ig7Er3oNIP9OQ18R0Jt5eebRSBgBlTLIF8ZS9T7DJApBezCl0Dr5u', 'employee', '2025-08-22 10:57:27', 1),
